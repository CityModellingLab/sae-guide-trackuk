...
### Load Area-Level Covariates

The area-level covariates are prepared in [Tutorial: Data Prep for Auxiliary Data](dataprep-auxdata.qmd).
...
covariates_commute_summer <- read_csv(
  covariate_url,
  show_col_types = FALSE
)
